...
export function CVResume() {
  ...
  return (
    <div id="cv-resume" className="w-full max-w-4xl mx-auto">
      <div className="bg-background rounded-[32px] border border-border/60 p-8 sm:p-12 shadow-lg">
        {/* Header */}
        <div className="mb-8 pb-8 border-b border-border/60">
          <div className="mb-6">
            <Typography variant="h1" className="text-4xl sm:text-5xl mb-2">
              Muhammad Ahmad
            </Typography>
            <Typography variant="lead" className="text-lg text-muted-foreground">
              Senior WordPress Developer | MERN Full-Stack Developer (Fresher)
            </Typography>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h4 className="font-semibold text-foreground mb-2">WordPress</h4>
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-muted-foreground">31 Green, Remote</p>
                    <a
            ...
            <div className="border-l-2 border-primary-500 pl-6">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-muted-foreground">KiwiLogics, Rawalpindi</p>
                    <a
            ...
            <div className="border-l-2 border-primary-500 pl-6">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-muted-foreground">SMEK Software Agency</p>
                    <a
        ...
        <div className="pt-6 border-t border-border/60 flex justify-center">
          <button
            ...
            className="inline-flex items-center justify-center px-8 py-3 text-base font-medium rounded-xl border-2 border-border/60 hover:border-foreground/50 hover:bg-accent transition-all duration-300 bg-background/50 text-foreground disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isGeneratingPDF ? (
              <>
